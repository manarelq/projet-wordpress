...
function blossom_fashion_customize_register_general( $wp_customize ) {
    ...
    $wp_customize->add_control(
        ...
        array(
            'section'         => 'instagram_settings',
            'label'           => __( 'Shortcode', 'blossom-fashion' ),
            'type'            => 'text',
            'description'     => __( 'Add shortcode for your instagram profile below:', 'blossom-fashion' ),
            'active_callback' => 'blossom_fashion_ed_instagram'
        )
    );
...
*/
function blossom_fashion_ed_instagram($control){
