...
const pluginList = [
    {
        pluginName: __("BlossomThemes Email Newsletter", "blossom-fashion"),
        description: __("Easily add email subscription form to your website using shortcode and widget.", "blossom-fashion"),
        slug: "blossomthemes-email-newsletter"
    },
    {
        pluginName: __("Regenerate Thumbnails", "blossom-fashion"),
        description: __("Regenerate the thumbnails for one or more of your image uploads. Useful when changing their sizes or your theme.", "blossom-fashion"),
        slug: "regenerate-thumbnails"
    },
    {
        pluginName: __("BlossomThemes Toolkit", "blossom-fashion"),
        description: __("BlossomThemes Toolkit provides you necessary widgets for better and effective blogging.", "blossom-fashion"),
        slug: "blossomthemes-toolkit"
    },
    {
        pluginName: __("Woocommerce", "blossom-fashion"),
        description: __("Everything you need to launch an online store in days and keep it growing for years. From your first sale to millions in revenue, Woo is with you.", "blossom-fashion"),
        slug: "woocommerce"
    },
    {
        pluginName: __("Smash Balloon Social Photo Feed", "blossom-fashion"),
        description: __("Formerly 'Instagram Feed'. Display clean, customizable, and responsive Instagram feeds from multiple accounts. Supports Instagram oEmbeds.", "blossom-fashion"),
        slug: "instagram-feed"
    },
];
